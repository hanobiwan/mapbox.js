...
var MapboxLogoControl = L.Control.extend({
    ...
    addLogo: function(json) {
        // If account referenced by the accessToken is
        // asscociated with the Mapbox Logo, display logo.
        var mapid = typeof this.options.urlOrMapID === 'string' && this.options.urlOrMapID.indexOf('/') === -1 ? true : false;
    ...
    _update: function() {
        ...
        this._container.innerHTML = this._mapboxLogo;
